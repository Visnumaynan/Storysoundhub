    ...
    public function run(): void
    {
        DB::table('books')->insert([
            ...
            [
                ...
                'owner_id' => DB::table('users')->where('username', 'jane_doe')->value('id'),
                'condition' => 'Used - Good',
                'quantity' => 3,
                'upload_date' => Carbon::now(),
                'created_at' => Carbon::now(),
            ...
            [
                ...
                'owner_id' => DB::table('users')->where('username', 'alice_smith')->value('id'),
                'condition' => 'New',
                'quantity' => 6,
                'upload_date' => Carbon::now(),
                'created_at' => Carbon::now(),
            ...
            [
                ...
                'owner_id' => DB::table('users')->where('username', 'bob_jones')->value('id'),
